...
#house_data <- subset(house_data, GrLivArea < 4000)
#house_data <- subset(house_data, X1stFlrSF < 2000)
#house_data <- subset(house_data, SalePrice < 400000)
#house_data <- subset(house_data, TotalBsmtSF < 2000)
#house_data <- subset(house_data, OverallQual < 8 & OverallQual > 3)
#house_data <- subset(house_data, GarageArea < 1000)



#subset=house_trn$GrLivArea<3000 & house_trn$X1stFlrSF<2000  & house_trn$SalePrice<400000 & house_trn$TotalBsmtSF<2000 & house_trn$OverallQual>3 & house_trn$OverallQual<7)
...
var_sel = c("YearBuilt", "YearRemodAdd","TotalBsmtSF", "X1stFlrSF","GrLivArea", "FullBath", "TotRmsAbvGrd", "GarageArea","OverallQual")
...
#int_add_mod = lm(log(SalePrice) ~ (OverallQual + YearBuilt + YearRemodAdd + log(GrLivArea) + log(TotRmsAbvGrd) +ExterQual+Neighborhood  )^2, data = house_trn,subset=house_trn$GrLivArea<3000 & house_trn$X1stFlrSF<2000  & house_trn$SalePrice<400000 & house_trn$TotalBsmtSF<2000 & house_trn$OverallQual>3 & house_trn$OverallQual<7)
...
interation_model = lm(log(SalePrice) ~ (OverallQual + YearBuilt + YearRemodAdd + log(TotalBsmtSF+1) + log(X1stFlrSF) + log(GrLivArea) + TotRmsAbvGrd )^2, data = house_trn,subset=house_trn$GrLivArea<3000 & house_trn$X1stFlrSF<2000  & house_trn$SalePrice<400000 & house_trn$TotalBsmtSF<2000 & house_trn$OverallQual>3 & house_trn$OverallQual<7)

bptest(interation_model)
shapiro.test(resid(interation_model))
