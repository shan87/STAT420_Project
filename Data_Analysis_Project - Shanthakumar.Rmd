...
add_mod = lm(log(SalePrice) ~  (MSSubClass + MSZoning  +GrLivArea + TotalBsmtSF + OverallQual+ YearBuilt+ FullBath + YearRemodAdd + Neighborhood +TotRmsAbvGrd+ExterQual +GarageArea), data = house_trn)
