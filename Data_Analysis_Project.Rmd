...
var_sel = c("LotFrontage", "OverallQual", "YearBuilt", "YearRemodAdd", "MasVnrArea" ,  "BsmtFinSF1", "TotalBsmtSF", "X1stFlrSF", "X2ndFlrSF","GrLivArea", "FullBath", "TotRmsAbvGrd", "Fireplaces", "GarageArea", "WoodDeckSF")
...
int_add_mod = lm(log(SalePrice) ~ LotFrontage + OverallQual + YearBuilt + YearRemodAdd + MasVnrArea +  BsmtFinSF1 + TotalBsmtSF + X1stFlrSF + X2ndFlrSF + log(GrLivArea) + Neighborhood  + FullBath + TotRmsAbvGrd + Fireplaces + GarageArea + WoodDeckSF + Foundation + MSSubClass + GarageType, data = house_trn)
summary(int_add_mod)
