...
It may be hard to use the AIC_Log_cd model for interpretation, as it has large number of parameters.

Usually if we are building a models for prediction purpose we can select the model based on the $R^2$ and RMSE values alone as the model will be good for prediction and we shouldn't be concerned about the number of parameter.
