...
#### Source
Below are the details about our dataset. We are using house prie data available at  https://www.kaggle.com/c/house-prices-advanced-regression-techniques . We will use regression techniques to analyze the data. 
...
- Removed `NA` and updated the values with `None` for character variables.
- We have Imputed `NA` with either `0`, `Mean`, `Medain` or `Mode` for numeric variables appropriatley.
