...
We can randomly split the train data set into 2 parts model_train and model_test, so that we will be able to test the model for the new data, which is not used for building the model and do some adjustment to models to avoid problems like over fitting.

```{r}

set.seed(1)
house_trn_idx = sample(1:nrow(train), 730)
